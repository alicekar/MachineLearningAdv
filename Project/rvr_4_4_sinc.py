...
# Test data
test_X = np.linspace(-10,10,num=1000).reshape(-1, 1)
test_T = np.array(generate_sinc_data(test_X)).reshape(1000)
...
for iter in range(20):
	...
	# Training data
	T = np.array(generate_sinc_uniform_data(X, 0.1)).reshape(100)
